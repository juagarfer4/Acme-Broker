...
<form:form action="${actionURI}" modelAttribute="supplier">
	...
	<form:label path="userAccount.username">
		<spring:message code="supplier.userAccount.username" />
	</form:label>
	...
	<form:label path="userAccount.password">
		<spring:message code="supplier.userAccount.password" />
	</form:label>
	...
	<form:label path="surname">
		<spring:message code="supplier.surname" />
	</form:label>
	...
	<form:label path="companyName">
		<spring:message code="supplier.companyName" />
	</form:label>
	...
	<form:label path="ticker">
		<spring:message code="supplier.ticker" />
	</form:label>
	<form:input path="ticker" />
	<form:errors cssClass="error" path="ticker"/>
	<br />
	
	<h3><spring:message code="supplier.creditCard.title" /></h3>
	
	<form:label path="creditCard.holderName">
		<spring:message code="supplier.creditCard.holderName" />
	</form:label>
	...
	<form:label path="creditCard.brandName">
		<spring:message code="supplier.creditCard.brandName" />
	</form:label>
	...
	<form:label path="creditCard.expirationMonth">
		<spring:message code="supplier.creditCard.expirationMonth" />
	</form:label>
	...
	<form:label path="creditCard.expirationYear">
		<spring:message code="supplier.creditCard.expirationYear" />
	</form:label>
	...
	<form:label path="creditCard.cVVCode">
		<spring:message code="supplier.creditCard.cVVCode" />
	</form:label>
	...
	<form:label path="creditCard.cardNumber">
		<spring:message code="supplier.creditCard.cardNumber" />
	</form:label>
	<form:input path="creditCard.cardNumber" />
	<form:errors cssClass="error" path="creditCard.cardNumber"/>
	<br />
	
	<input type="submit" name="save" value="<spring:message code="supplier.register" />" />
	&nbsp;
	<a href="<spring:url value='/' />"><input type="button" name="Back"
		value="<spring:message code="supplier.cancel"/>" /></a>
